...
//  TestPortraitMatte
//
//  Created by 萬年　司 on 2019/06/24.
//  Copyright © 2019 萬年　司. All rights reserved.
//
...
class ViewController: UIViewController{
    ...
    private func loadImage(at url: URL) {
        ...
        print(CGImageSourceCopyAuxiliaryDataInfoAtIndex(self.imageSource!, 0, kCGImageAuxiliaryDataTypePortraitEffectsMatte) as? [String : AnyObject])
...
//    private func getPortraitMatte() {
//        var depthDataMap: CVPixelBuffer? = nil
//        if let matteData = imageSource?.getNewMatteData() {
//            depthDataMap = matteData.mattingImage
//            print(matteData.matteType)
//        }
//        mattePixelBuffer = depthDataMap
//    }
